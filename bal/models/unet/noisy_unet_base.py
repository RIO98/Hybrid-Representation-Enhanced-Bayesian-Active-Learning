...
from bal.models.functions import crop
...
class NoisyUNetBaseBlock(nn.Module):
    ...
    def __init__(self,
        ...
        super(NoisyUNetBaseBlock, self).__init__()
...
class NoisyUNetContractionBlock(NoisyUNetBaseBlock):
    pass


class NoisyUNetExpansionBlock(NoisyUNetBaseBlock):
    ...
    def __init__(self,
        ...
        super(NoisyUNetExpansionBlock, self).__init__(
            ndim,
            conv_nfilter_in,
            conv_nfilter_out,
            conv_param,
...
class NoisyUNetBase(Model):
    ...
    def __init__(self,
        ...
        super(NoisyUNetBase, self).__init__()
        ...
        for i in range(nlayer):
            self.add_module('contraction_block_%d' % i,
                            NoisyUNetContractionBlock(ndim,
